...
const LiveChat = () => {
  ...
  return (
    <div className="relative bg-[#0f172a] z-10 border border-white/10 w-full h-[600px] min-h-0 flex flex-col p-4 rounded-2xl shadow-lg">
